...
function closeMenu() {
  ...
  $.post('https://JLRP-Hud/closeMenu');
}
function restartHud() {
  closeMenu()
  $.post('https://JLRP-Hud/restartHud');
}
function resetStorage() {
  closeMenu()
  $.post('https://JLRP-Hud/resetStorage');
}
function showOutMap() {
  $.post('https://JLRP-Hud/showOutMap');
}
function showOutCompass() {
  $.post('https://JLRP-Hud/showOutCompass');
}
function showFollowCompass() {
  $.post('https://JLRP-Hud/showFollowCompass');
}
function openMenuSounds() {
  $.post('https://JLRP-Hud/openMenuSounds');
}
function resetHudSounds() {
  $.post('https://JLRP-Hud/resetHudSounds');
}
function checklistSounds() {
  $.post('https://JLRP-Hud/checklistSounds');
}
function showMapNotif() {
  $.post('https://JLRP-Hud/showMapNotif');
}
function showFuelAlert() {
  $.post('https://JLRP-Hud/showFuelAlert');
}
function showCinematicNotif() {
  $.post('https://JLRP-Hud/showCinematicNotif');
}
function dynamicHealth() {
  $.post('https://JLRP-Hud/dynamicHealth');
}
function dynamicArmor() {
  $.post('https://JLRP-Hud/dynamicArmor');
}
function dynamicHunger() {
  $.post('https://JLRP-Hud/dynamicHunger');
}
function dynamicThirst() {
  $.post('https://JLRP-Hud/dynamicThirst');
}
function dynamicStress() {
  $.post('https://JLRP-Hud/dynamicStress');
}
function dynamicOxygen() {
  $.post('https://JLRP-Hud/dynamicOxygen');
}
function dynamicEngine() {
  $.post('https://JLRP-Hud/dynamicEngine');
}
function dynamicNitro() {
  $.post('https://JLRP-Hud/dynamicNitro');
}
function ToggleMapShape() {
  $.post('https://JLRP-Hud/ToggleMapShape');
}
function changeFPS() {
  $.post('https://JLRP-Hud/changeFPS');
}
function ToggleMapBorders() {
  $.post('https://JLRP-Hud/ToggleMapBorders');
}
function HideMap() {
  $.post('https://JLRP-Hud/HideMap');
}
function changeCompassFPS() {
  $.post('https://JLRP-Hud/changeCompassFPS');
}
function showCompassBase() {
  $.post('https://JLRP-Hud/showCompassBase');
}
function showStreetsNames() {
  $.post('https://JLRP-Hud/showStreetsNames');
}
function showPointerIndex() {
  $.post('https://JLRP-Hud/showPointerIndex');
}
function showDegreesNum() {
  $.post('https://JLRP-Hud/showDegreesNum');
}
function cinematicMode() {
  $.post('https://JLRP-Hud/cinematicMode');
}
