...
Config.Menu = {
    ...
    isCompassFollowChecked = false, -- isCompassFollowChecked
    ...
    isDynamicHealthChecked = false, -- isDynamicHealthChecked
    isDynamicArmorChecked= false, -- isDynamicArmorChecked
    isDynamicHungerChecked = false, -- isDynamicHungerChecked
    isDynamicThirstChecked = false, -- isDynamicThirstChecked
